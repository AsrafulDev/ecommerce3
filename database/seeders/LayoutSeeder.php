    ...
    public function run(): void
    {
        ...
        $layouts = [
            [
                ...
                'description' => 'Complete homepage with all major sections including hero sliders',
                'is_default' => true,
                'is_active' => true,
                'sections' => [
                    ['slug' => 'fullwidth-slider',   'order' => 1,  'cols' => 'col-sm-12'],
                    ['slug' => 'main-slider',         'order' => 2,  'cols' => 'col-sm-9'],
                    ['slug' => 'hero-slider',         'order' => 3,  'cols' => 'col-sm-12'],
                    ['slug' => 'top-categories',      'order' => 4,  'cols' => 'col-sm-12'],
                    ['slug' => 'flash-sales',         'order' => 5,  'cols' => 'col-sm-12'],
                    ['slug' => 'hot-deals',           'order' => 6,  'cols' => 'col-sm-12'],
                    ['slug' => 'all-products',        'order' => 7,  'cols' => 'col-sm-12'],
                    ['slug' => 'slider-bottom-ads',   'order' => 8,  'cols' => 'col-sm-12'],
                    ['slug' => 'category-products',   'order' => 9,  'cols' => 'col-sm-12'],
                    ['slug' => 'campaign-ads',        'order' => 10, 'cols' => 'col-sm-12'],
                    ['slug' => 'brands',              'order' => 11, 'cols' => 'col-sm-12'],
                    ['slug' => 'latest-blogs',        'order' => 12, 'cols' => 'col-sm-12'],
                    ['slug' => 'customer-reviews',    'order' => 13, 'cols' => 'col-sm-12'],
                    ['slug' => 'footer-top-ads',      'order' => 14, 'cols' => 'col-sm-12'],
                ],
            ],
            [
