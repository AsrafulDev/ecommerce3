        ...
        <div class="col-lg-4 mb-4">
            <div class="profile-card">
                ...
                <ul class="profile-info-list mt-4">
                    <li>
                        <span class="label-text"><i data-feather="hash" style="width:14px;" class="me-2"></i> {{ __('Employee ID') }} </span>
                        <span class="val-text">{{ $employee->employee_id }}</span>
                    </li>
                    <li>
                        <span class="label-text"><i data-feather="briefcase" style="width:14px;" class="me-2"></i> {{ __('Department') }} </span>
                    ...
                    <li>
                        <span class="label-text"><i data-feather="calendar" style="width:14px;" class="me-2"></i> {{ __('Joined') }} </span>
        ...
        <div class="col-lg-8">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="overview">
                    ...
                    <div class="row">
                        <div class="col-md-6 overview-item">
                            <div class="overview-label"> {{ __('Full Name') }} </div>
                            <div class="overview-value">{{ $employee->name }}</div>
                        </div>
                        <div class="col-md-6 overview-item">
                            <div class="overview-label"> {{ __('Linked User Account') }} </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 overview-item">
                            <div class="overview-label"> {{ __('Bank Name') }} </div>
                ...
                <div class="tab-pane fade" id="payroll">
                    <h6 class="fw-bold mb-3"> {{ __('Salary Slips') }} </h6>
