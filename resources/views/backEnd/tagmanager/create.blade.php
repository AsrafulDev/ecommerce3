...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;"> {{ __('Add Tag Manager') }} </h4>
                <p class="text-muted font-size-13 mb-0"> {{ __('Configure Google Tag Manager container.') }} </p>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title"> {{ __('GTM Configuration') }} </h5>
                </div>
                <div class="card-body">
                    <form action="{{route('tagmanagers.store')}}" method="POST" data-parsley-validate>
                        ...
                        <div class="form-group mb-4">
                            <label for="code" class="form-label"> {{ __('Tag Manager ID') }} <span class="text-danger">*</span></label>
