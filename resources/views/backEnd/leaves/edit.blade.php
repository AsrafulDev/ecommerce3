                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="leave_type" class="form-select form-select-custom @error('leave_type') is-invalid @enderror" required>
                                <option value="" disabled> {{ __('Choose Leave Type...') }} </option>
                                <option value="casual" {{ $leave->leave_type == 'casual' ? 'selected' : '' }} class="leave-type-option"> {{ __('Casual Leave') }} </option>
                                <option value="sick" {{ $leave->leave_type == 'sick' ? 'selected' : '' }} class="leave-type-option"> {{ __('Sick Leave') }} </option>
                                <option value="annual" {{ $leave->leave_type == 'annual' ? 'selected' : '' }} class="leave-type-option"> {{ __('Annual Leave') }} </option>
                                ...
                                <option value="unpaid" {{ $leave->leave_type == 'unpaid' ? 'selected' : '' }} class="leave-type-option"> {{ __('Unpaid Leave') }} </option>
                            </select>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <label class="form-label-custom"> {{ __('Start Date') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                <label class="form-label-custom"> {{ __('End Date') }} <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0 text-muted"><i data-feather="calendar" style="width:16px;"></i></span>
                        ...
                        {{-- Reason --}}
                        <div class="mb-4">
                            <label class="form-label-custom"> {{ __('Reason for Leave') }} </label>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('admin.leaves.index') }}" class="btn btn-light py-2"> {{ __('Discard Changes') }} </a>
                        </div>
