...
@section('title','{{ __('{{ __('Shipping') }} Charge') }} {{ __('Manage') }}ment')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold m-0 text-dark">{{ __('{{ __('{{ __('Shipping') }} Charge') }}s') }}</h4>
            <span class="text-muted small">{{ __('{{ __('Manage') }} delivery areas and costs') }}</span>
        </div>
                    ...
                    <table id="datatable-buttons" class="table table-pro dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                ...
                                <th width="50%">{{ __('{{ __('Area') }} {{ __('Name') }}') }}</th>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('shippingcharges.edit',$value->{{ __('id)') }} }}" class="btn-action btn-edit" title="{{ __('Edit') }}">
                                            <i class="fe-edit-1" style="font-size: 16px;"></i>
                                        </a>

                                        <form action="{{ route('shippingcharges.destroy') }}" method={{ __('"{{ __('POST') }}"') }} class="delete-form d-inline">
                                            @csrf
