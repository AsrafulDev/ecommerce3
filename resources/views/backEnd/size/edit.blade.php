...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Size: {{ $edit_data->size{{ __('Name') }} }}</h4>
    ...
    <form action="{{route('sizes.update')}}" method={{ __('"{{ __('POST') }}"') }} enctype="multipart/form-data" data-parsley-validate>
        @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('size{{ __('Name') }}') is-invalid @enderror" 
                                   name="size{{ __('Name') }}" value="{{ $edit_data->size{{ __('Name') }} }}" id="size{{ __('Name') }}" required>
                            @error('size{{ __('Name') }}')
