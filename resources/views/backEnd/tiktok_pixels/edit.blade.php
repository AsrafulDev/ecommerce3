...
@section('title','{{ __('Edit TikTok Pixel') }}')
...
<div class="container-fluid">
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;">{{ __('Edit TikTok Pixel') }}</h4>
                <p class="text-muted font-size-13 mb-0">{{ __('Update TikTok tracking pixel configuration.') }}</p>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">{{ __('Update TikTok Pixel') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('tiktok.pixels.update')}}" method={{ __('"{{ __('POST') }}"') }} data-parsley-validate>
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            <div class="d-flex justify-content-between align-items-center border p-3 rounded bg-light">
                                <div>
                                    ...
                                    <small class="d-block text-muted">{{ __('{{ __('Enable') }}/Disable tracking') }}</small>
                                </div>
                                <label class="switch">
