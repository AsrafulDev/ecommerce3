...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;">{{ __('Edit Pixel') }}</h4>
                <p class="text-muted font-size-13 mb-0">{{ __('Update tracking pixel configuration.') }}</p>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">{{ __('Update {{ __('Pixel {{ __('Configuration') }}') }}') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('pixels.update')}}" method={{ __('"{{ __('POST') }}"') }} data-parsley-validate>
                        @csrf
