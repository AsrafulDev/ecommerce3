...
<div class="container-fluid py-3">
  <div class="row">
    <div class="col-12">
      <h4 class="fw-bold mb-3"><i class="fe-facebook text-primary me-2"></i> {{ __('Facebook Page - Auto Post Products') }} </h4>
    ...
    <div class="card">
      <div class="card-body">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <label> {{ __('Page Access Token') }} </label>
            ...
            <small class="text-muted"> {{ __('Generate from') }} <a href="https://developers.facebook.com/tools/explorer/" target="_blank"> {{ __('Graph API Explorer') }} </a> with pages_manage_posts, pages_read_engagement</small>
          </div>
          <div class="col-md-6">
            <label> {{ __('Page Name (optional)') }} </label>
