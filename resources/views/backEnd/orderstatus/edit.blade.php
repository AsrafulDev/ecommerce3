...
@section('title','Edit {{ __('Order {{ __('Status') }}') }}')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit {{ __('Order {{ __('Status') }}') }}: {{ $edit_data->name }}</h4>
                    <p class="text-muted font-size-13 mb-0">{{ __('Update status details and configuration.') }}</p>
                </div>
    ...
    <form action="{{route('orderstatus.update')}}" method={{ __('"{{ __('POST') }}"') }} enctype="multipart/form-data" data-parsley-validate>
        @csrf
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <h5 class="card-title">{{ __('{{ __('Status') }} Information') }}</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button type="{{ __('submit') }}" class="btn btn-{{ __('submit') }} w-100 rounded-pill">
                            <i class="fe-check-circle me-1"></i> {{ __('Update {{ __('Status') }}') }}
                        </button>
                    </div>
                </div>
