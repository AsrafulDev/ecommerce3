...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold m-0 text-dark">
                ...
                @else
                    <i class="mdi mdi-view-dashboard-plus me-2"></i> Create New Layout
                @endif
            </h4>
            <a href="{{ route('layouts.index') }}" class="text-muted small">
                <i class="fe-arrow-left me-1"></i> Back to Layouts
            </a>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <form action="{{ $edit_data ? route('layouts.update') : route('layouts.store') }}" method="POST">
                @csrf
                @if($edit_data)
