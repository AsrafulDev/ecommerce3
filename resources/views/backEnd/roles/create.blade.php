...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;"> {{ __('Create New Role') }} </h4>
                ...
                <div class="card-body">
                    <form action="{{route('roles.store')}}" method="POST" data-parsley-validate>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 mt-3">
                            <h5 class="text-uppercase text-muted font-size-14 fw-bold"> {{ __('Assign Permissions') }} </h5>
                            
                            <div class="select-all-wrapper">
                                <span class="font-size-13 fw-bold text-primary"> {{ __('Select All Permissions') }} </span>
