...
@section('title','{{ __('{{ __('Landing Page') }} Create') }}')
@section('css')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('{{ __('Landing Page') }} Create') }}</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
   <div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('campaign.store') }}" method={{ __('"{{ __('POST') }}"') }} class="row" data-parsley-validate="" enctype="multipart/form-data" name="createForm">
                    @csrf
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">{{ __('{{ __('{{ __('Landing Page') }} {{ __('Title') }}') }} *') }}</label>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="banner" class="form-label">{{ __('{{ __('Banner Image') }} *') }}</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="banner_title" class="form-label">{{ __('{{ __('Banner {{ __('Title') }}') }} *') }}</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="top_title_1" class="form-label">{{ __('Top {{ __('Title') }} 1') }}</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="top_title_2" class="form-label">{{ __('Top {{ __('Title') }} 2') }}</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="product_id" class="form-label">{{ __('{{ __('Product') }}s *') }}</label>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            <label for="image_one" class="form-label">{{ __('{{ __('Image One') }} *') }}</label>
                    ...
                    <div class="col-sm-6 mb-3">
                        <label for="image">{{ __('{{ __('Review') }} {{ __('Image *') }}') }}</label>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group mb-3">
                            <label for="review" class="form-label">{{ __('{{ __('Review') }} *') }}</label>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="short_description" class="form-label">{{ __('{{ __('Short Description') }} *') }}</label>
                    ...
                    <div>
                        <input type="{{ __('submit') }}" class="btn btn-success" value="Create {{ __('Campaign') }}">
                    </div>
                </form>
