...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">{{ __('Create {{ __('New') }} {{ __('Color') }}') }}</h4>
    ...
    <form action="{{route('colors.store')}}" method={{ __('"{{ __('POST') }}"') }} enctype="multipart/form-data" data-parsley-validate>
        @csrf
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <h5 class="card-title">{{ __('{{ __('Color') }} Details') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('color{{ __('Name') }}') is-invalid @enderror" 
                                           name="color{{ __('Name') }}" value="{{ old('color{{ __('Name') }}') }}" id="color{{ __('Name') }}" 
                                           placeholder="{{ __('e.g. Midnight Blue') }}" required>
                                    @error('color{{ __('Name') }}')
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button type="{{ __('submit') }}" class="btn btn-{{ __('submit') }} w-100 rounded-pill">
                            <i class="fe-check-circle me-1"></i> Save {{ __('Color') }}
                        </button>
                    </div>
                </div>
