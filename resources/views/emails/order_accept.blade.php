...
<div style="background:#fff; width:90%;margin:0 auto !important">
    ...
    <table class="body-wrap" style="background:#fff; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 16px; width: 100%; margin: 0;padding:0 30px">
        <tbody style="background:#fff">
            ...
            <tr>
                <td style="padding:30px 0;border:0">Thanks — we've received your payment for order ID #{{$order->invoice_id}}, and we are processing your order. <strong style="background:yellow;font-weight:700;"> {{ __('Getting a delivery email will take a maximum time of 10 {{ __('Minutes') }} to 5 hours.') }}</strong></td></br>
            </tr>
        </tbody>
    </table>
    ...
    <table style="padding:10px 0px;margin-bottom:25px;text-align:center !important;width:100%">
        <tbody>
            ...
            <tr><td>{{$order->shipping?$order->shipping->{{ __('phone') }}:''}}</td></tr>
