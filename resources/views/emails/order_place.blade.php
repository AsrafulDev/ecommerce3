...
<div style="background:#fff; width:90%;margin:0 auto !important">
    ...
    <table class="body-wrap" style="background:#fff; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 16px; width: 100%; margin: 0;padding:0 30px">
        <tbody style="background:#fff">
            ...
            <tr>
                <td style="padding:30px 0;border:0">Thanks — Your order was placed successfully. Order ID #{{$order->invoice_id}}. You will receive a processing email as soon as possible. or check the status of your order from <a href="{{ __('https://') }}giftshopbd.websolutionit.com/customer/orders" style="font-weight:900;color:blue">{{ __('here') }}</a></td></br>
            </tr>
        </tbody>
    </table>
