            ...
            <div class="col-sm-12">
                <div class="category-product main_product_inner">
                    ...
                    <div class="col-12 text-center py-5">
                        <h4>{{ __('No flash sale products available right now.') }}</h4>
                        <p>{{ __('Check back soon for amazing deals!') }}</p>
                        <a href="{{ route('shop') }}" class="btn btn-primary mt-2">{{ __('Browse All Products') }}</a>
                    </div>
                    @endforelse
                </div>
            </div>
