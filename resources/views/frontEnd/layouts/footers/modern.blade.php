        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-6 col-md-3"><h6 class="fw-bold small mb-2">Account</h6><ul class="list-unstyled small text-muted"><li class="mb-1"><a href="{{ route('customer.account') }}" class="text-decoration-none text-muted">My Account</a></li><li class="mb-1"><a href="#" class="text-decoration-none text-muted">Orders</a></li><li class="mb-1"><a href="#" class="text-decoration-none text-muted">Wishlist</a></li></ul></div>
