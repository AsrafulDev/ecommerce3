{{-- {{ __('Footer Style') }} 5: {{ __('Columns') }} with App {{ __('Store') }} buttons --}}
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex gap-2 mt-2">
                    ...
                    <a href="{{ $generalsetting->app_store_link ?? '#' }}" target="_blank"><img src="{{ asset('public/assets/images/app.png') }}" alt="App {{ __('Store') }}" style="height:35px;"></a>
                </div>
            </div>
            @foreach([['{{ __('Shop') }}','shop','hotdeals','flashsales'],['Help','contact','faq','shipping'],['Account','customer.account','orders','customer.account'],['Connect','facebook','instagram','youtube']] as $col)
            ...
            @endforeach
            <div class="col-lg-3 col-md-6">
                <h6 class="fw-bold small mb-3">{{ __('Contact') }}</h6>
                <ul class="list-unstyled small text-secondary">
                    <li class="mb-1"><i class="fa-solid fa-{{ __('phone') }} me-2"></i>{{ $contact->hotline ?? '{{ __('N/A') }}' }}</li>
                    <li class="mb-1"><i class="fa-solid fa-envelope me-2"></i>{{ $contact->email ?? '{{ __('N/A') }}' }}</li>
