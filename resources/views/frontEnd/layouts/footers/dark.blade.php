...
<footer class="bg-dark text-white">
    <div class="container py-5">
        <div class="row g-4">
            ...
            <div class="col-lg-8"><div class="row"><div class="col-6 col-md-3"><h6 class="text-uppercase small mb-3">Links</h6><ul class="list-unstyled small text-secondary"><li class="mb-1"><a href="{{ route('home') }}" class="text-secondary text-decoration-none">{{ __('Home') }}</a></li><li class="mb-1"><a href="{{ route('shop') }}" class="text-secondary text-decoration-none">Shop</a></li><li class="mb-1"><a href="{{ route('brands') }}" class="text-secondary text-decoration-none">{{ __('Brands') }}</a></li></ul></div><div class="col-6 col-md-3"><h6 class="text-uppercase small mb-3">{{ __('Support') }}</h6><ul class="list-unstyled small text-secondary"><li class="mb-1"><a href="{{ route('contact') }}" class="text-secondary text-decoration-none">Contact</a></li><li class="mb-1"><a href="#" class="text-secondary text-decoration-none">{{ __('FAQ') }}</a></li></ul></div><div class="col-md-6"><h6 class="text-uppercase small mb-3">{{ __('Newsletter') }}</h6><div class="input-group input-group-sm"><input type="email" class="form-control bg-transparent border-secondary text-white" placeholder="{{ __('Email') }}"><button class="btn btn-light btn-sm">{{ __('Subscribe') }}</button></div></div></div></div>
        </div>
