        ...
        <div class="row align-items-center py-2">
            ...
            <div class="col-lg-4 col-6 text-end">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    @guest('customer')
                        <a href="{{ route('customer.login') }}" class="btn btn-outline-primary btn-sm rounded-pill px-3">Login</a>
                    @endguest
    ...
    <nav style="border-top:1px solid #eee;border-bottom:2px solid var(--primary-color);">
        <div class="container">
            <ul class="d-flex list-unstyled mb-0 gap-1">
                ...
                <li><a href="{{ route('category','smartphones') }}" class="d-block px-3 py-2 text-dark">Categories</a></li>
                <li><a href="{{ route('hotdeals') }}" class="d-block px-3 py-2 text-dark">Deals</a></li>
                <li><a href="{{ route('brands') }}" class="d-block px-3 py-2 text-dark">Brands</a></li>
            </ul>
        </div>
    </nav>
</header>
