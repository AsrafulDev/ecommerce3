    ...
    public static function all(): array
    {
        return [
            'gadget-fashion-grocery' => [
                ...
                'live_url'    => 'https://ecommerce1.softmit.xyz/',
                'color'       => '#0d6efd',
                'icon'        => 'mdi-store',
            ],
            'electronics' => [
                ...
                'live_url'    => 'https://ecommerce2.softmit.xyz/',
                'color'       => '#dc2626',
                'icon'        => 'mdi-laptop',
            ],
            'food-grocery' => [
                ...
                'live_url'    => 'https://ecommerce3.softmit.xyz/',
                'color'       => '#16a34a',
                'icon'        => 'mdi-food-apple',
            ],
            'clothing-fashion' => [
                ...
                'live_url'    => 'https://ecommerce6.softmit.xyz/',
                'color'       => '#9333ea',
                'icon'        => 'mdi-hanger',
            ],
            'beauty' => [
                ...
                'live_url'    => 'https://ecommerce7.softmit.xyz/',
                'color'       => '#ec4899',
