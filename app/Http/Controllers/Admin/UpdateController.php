...
class UpdateController extends Controller
{
    ...
    /**
     * Get update settings. The installed version is hardcoded in config/app.php
     * so a database value cannot change the running application's version.
     */
    private function getUpdateSettings(): array
    {
        return [
            ...
            'current_version' => (string) config('app.version', '1.0.0'),
        ];
    }
